...
<head>
    ...
    <title>Login Admin Perpustakaan - SDN 3 Krenceng</title>
    <style>
    ...
    <div class="login-container">
        ...
        <div class="login-left">
            ...
            <div class="login-left-text">
                ...
                <p>Portal sistem informasi perpustakaan untuk Admin Perpustakaan</p>
            </div>
        </div>
        ...
        <div class="login-right">
            ...
            <h2 class="login-heading">Masuk Admin Perpustakaan</h2>
            ...
            <form action="{{ route('login_perpustakaan.store') }}" method="POST">
                @csrf
